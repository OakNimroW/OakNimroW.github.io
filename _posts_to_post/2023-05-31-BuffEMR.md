...
* -sCV 
  Indica que se quiere utilizar scripts de nmap para escanear vulnerabilidades y versiones de los servicios 
...
# ME FALTA ANOTAR UN POCO MAS DE CHEQUEO COMO BUSCAR INFORMACION DE ALGUNA BASE DE DATOS
